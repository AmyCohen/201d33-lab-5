...
//array[sum of numbers in array, string]
//do NOT use +
  var firstAddArray = sum(testArray[0], testArray[1])[0];
  var answerAddArray = sum(firstAddArray, testArray[2])[0];
  console.log(answerAddArray);
  var sentenceForArray = testArray + ' was passed in as an array of numbers, and ' + answerAddArray + ' is their sum.';
  return [answerAddArray, sentenceForArray];
}
